...
def start(input):
    for index, i in enumerate(input):
        if i != input[index+1] and i != input[index+2] and i != input[index+3]:
            if input[index+1] != input[index+2] and input[index+1] != input[index+3]:
                    ...
                    if input[index+3] not in input[index+4:index+14]:
                        if input[index+4] not in input[index+5:index+14]:
                            if input[index+5] not in input[index+6:index+14]:
                                if input[index+6] not in input[index+7:index+14]:
                                    if input[index+7] not in input[index+8:index+14]:
                                        if input[index+8] not in input[index+9:index+14]:
                                            if input[index+9] not in input[index+10:index+14]:
                                                if input[index+10] not in input[index+11:index+14]:
                                                    if input[index+11] not in input[index+12:index+14]:
                                                        if input[index+12] not in input[index+13:index+14]:
                                                            if input[index+13] not in input[index+14:index+14]:
                                                                return index+14
